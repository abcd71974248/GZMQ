...
public class ModulePagRetrofit extends BusiRetrofitHelper{


    private Context mContext;
    public ModulePagRetrofit(Context ctx) {
        super(ctx);
        this.mContext=ctx;
    ...
    public Call<ResponseResults> getServer(String route){
        ...
        Call<ResponseResults> call=syncPostRoute.getModulePostRoute(body);
        return call;
    }
