...
public class GetLdxxViewRetrofit extends BusiRetrofitHelper{

    private Context mContext;

    public GetLdxxViewRetrofit(Context ctx) {
        super(ctx);
        this.mContext=ctx;
    ...
    public Call<ResponseResults> getServer(String route){
        ...
        Call<ResponseResults> call=postRoute.getLdxxViewPostRoute(body);
        return call;
    }
