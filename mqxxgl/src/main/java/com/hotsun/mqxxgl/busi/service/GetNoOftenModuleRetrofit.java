...
public class GetNoOftenModuleRetrofit extends BusiRetrofitHelper{


    private Context mContext;
    public GetNoOftenModuleRetrofit(Context ctx) {
        super(ctx);
        this.mContext=ctx;
    ...
    public Call<ResponseResults> getServer(String route){
        ...
        Call<ResponseResults> call=syncPostRoute.getNoOftenModulePostRoute(body);
        return call;
    }
